...
const enTranslations = {
  ...
  "gettingStarted1": "Create a document from the dashboard, then add exercises manually or from images.",
  "gettingStarted2": "Enable 'Auto analyze images' in Settings for one‑click imports.",
  "gettingStarted3": "Use Print Preview to format and print (columns, sizes, themes).",
  "workflowTitle": "Typical workflow",
  "workflow1": "Dashboard → New document (title, class, year).",
  "workflow2": "Open document → Add from image (AI) or Add exercise (manual).",
  "workflow3": "Review content, adjust LaTeX, then Export → Print or Download.",
  "aiStepsTitle": "Image import (AI) — steps",
  "aiStep1": "Open 'Add from Images' → drop one or more images.",
  "aiStep2": "If API key is missing, open Settings and paste or capture it.",
  "aiStep3": "If Auto analyze is ON, analysis starts automatically.",
  "aiStep4": "Review results, uncheck 'Bold keywords' if not desired.",
  "aiStep5": "Click 'Add X Exercises' to insert into the document.",
  "aiTipsTitle": "Image tips",
  "aiTip1": "Prefer high contrast, good focus, and straight pages.",
  "aiTip2": "Crop out irrelevant margins and avoid shadows.",
  "aiTip3": "Complex layouts may need light manual cleanup.",
  "exportTitle": "Print & export tips",
  "exportTip1": "Use one or two columns depending on density.",
  "exportTip2": "Pick text size and theme (Default, Ink saver, High contrast).",
  "exportTip3": "Math is printed non‑bold, and empty pages are removed automatically.",
  "settingsHelpTitle": "Settings you may need",
  "settingsHelp1": "Google Gemini API Key → Verify before importing images.",
  "settingsHelp2": "Auto analyze images → triggers analysis on drop.",
  "shortcutsTitle": "Shortcuts",
  "shortcut1": "Esc → Close modals.",
  "shortcut2": "Ctrl/Cmd + P → Open browser print dialog from preview.",
  "shortcut3": "Enter → Confirm dialogs when focused.",
  "troubleshootTitle": "Troubleshooting",
  "trouble1": "Math not rendered: ensure LaTeX uses \\(...\\) or \\[...\\]; try re‑opening Print Preview.",
  "trouble2": "API invalid: open Settings, verify, then drop images again.",
  "trouble3": "Auto analyze not starting: confirm the setting is ON and the API key is valid.",
  "trouble4": "Printed formulas look bold: now fixed by styles; refresh preview.",
  "trouble5": "Blank pages in print: empty exercises are filtered out automatically.",
      "about": "About Mathify",
...
const frTranslations = {
  ...
  "gettingStarted1": "Créez un document depuis le tableau de bord, puis ajoutez des exercices manuellement ou depuis des images.",
  "gettingStarted2": "Activez 'Analyse auto des images' dans Paramètres pour des imports en un clic.",
  "gettingStarted3": "Utilisez l’Aperçu avant impression pour la mise en page (colonnes, tailles, thèmes).",
  "workflowTitle": "Parcours type",
  "workflow1": "Tableau de bord → Nouveau document (titre, classe, année).",
  "workflow2": "Dans le document → Ajouter depuis une image (IA) ou Ajouter un exercice (manuel).",
  "workflow3": "Vérifiez le contenu, ajustez le LaTeX, puis Exporter → Imprimer ou Télécharger.",
  "aiStepsTitle": "Import d’images (IA) — étapes",
  "aiStep1": "Ouvrir 'Ajouter depuis des Images' → déposer une ou plusieurs images.",
  "aiStep2": "Si la clé API manque, ouvrez Paramètres et collez/capturez-la.",
  "aiStep3": "Si l’analyse auto est activée, elle démarre automatiquement.",
  "aiStep4": "Relisez le résultat, désactivez 'Mots‑clés en gras' si besoin.",
  "aiStep5": "Cliquez sur 'Ajouter X exercices' pour insérer dans le document.",
  "aiTipsTitle": "Conseils pour les images",
  "aiTip1": "Privilégiez un bon contraste, une image nette et bien cadrée.",
  "aiTip2": "Recadrez les marges inutiles, évitez les ombres.",
  "aiTip3": "Les mises en page très complexes peuvent nécessiter une petite retouche.",
  "exportTitle": "Astuces d’impression & export",
  "exportTip1": "Choisissez une ou deux colonnes selon la densité.",
  "exportTip2": "Réglez la taille du texte et le thème (Défaut, Économie d’encre, Contraste élevé).",
  "exportTip3": "Les formules ne sont plus imprimées en gras et les pages vides sont ignorées.",
  "settingsHelpTitle": "Paramètres utiles",
  "settingsHelp1": "Clé API Google Gemini → Vérifiez-la avant l’import d’images.",
  "settingsHelp2": "Analyse auto des images → déclenche l’analyse au dépôt.",
  "shortcutsTitle": "Raccourcis",
  "shortcut1": "Échap → Fermer les fenêtres.",
  "shortcut2": "Ctrl/Cmd + P → Ouvrir l’impression depuis l’aperçu.",
  "shortcut3": "Entrée → Valider les dialogues quand le focus est sur un bouton.",
  "troubleshootTitle": "Dépannage",
  "trouble1": "Formules non rendues : utilisez \\(...\\) ou \\[...\\] ; rouvrez l’aperçu d’impression.",
  "trouble2": "API invalide : ouvrez Paramètres, vérifiez, puis redéposez les images.",
  "trouble3": "Analyse auto ne démarre pas : activez l’option et vérifiez la clé.",
  "trouble4": "Formules imprimées en gras : corrigé par les styles ; actualisez l’aperçu.",
  "trouble5": "Pages vides : les exercices vides sont filtrés automatiquement.",
